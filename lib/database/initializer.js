...
function addConnectionPool(configuration){
    if(!configuration.user || !configuration.password || !configuration.connectString)
        throw `To add a new connection pool you need to send a object. The default object
        is:  
                {
                    poolAlias: 'default', 
                    poolMax: 10,
        ...
        user, password and connectString are required. Other properties will have the default value;
        ` 
